...
class AdminTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.role_label.setStyleSheet(f"background-color: {BURGUNDY}; color: {WHITE}; font-weight: bold; font-size: 25px; padding: 12px; border-radius: 5px;")
...
class UserTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.role_label.setStyleSheet(f"background-color: {BURGUNDY}; color: {WHITE}; font-weight: bold; font-size: px; padding: 8px; border-radius: 5px;")
        self.role_label.setAlignment(Qt.AlignCenter)
        layout.addWidget(self.role_label)
        ...
        self.tabs.setTabText(2, "Account Details")
